...
// output:
//    java throwtest - Must specify an argument
//    java throwtest one -  Must specify an integer argument
//    java throwtest 0 - i = 0\n MyException: input too low \nHandled at point 1\n
//    java throwtest 1 - i = 1\n MySubException: input still too low \nHandled at point 1\n
//    java throwtest 99 - i = 99MyOtherException: input too high \nHandled at point 2\n
//    java throwtest 2 - i = 2\n c(i) = 4\n
//    java throwtest 3 - i = 3\n c(i) = 9\n
